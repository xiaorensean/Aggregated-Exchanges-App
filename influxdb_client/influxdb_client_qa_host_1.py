...
HOST_QA_1 = "ec2-15-222-236-45.ca-central-1.compute.amazonaws.com"

# database name
database = 'md_rates'


class InfluxClientHostQA1:
    
    def __init__(self):        
        user_name = ''
        passwords = ''         
        self.client = InfluxDBClient(host=HOST_QA_1, port=8086, username=user_name, password=passwords)
...
if __name__ == '__main__':
    ...
    #a = db.get_tag_values('huobidm_index_price','symbol')
    ...
    #db.delete('huobidm_index_price',"2020-02-13 17:24:00","2020-02-13 18:45:00")
