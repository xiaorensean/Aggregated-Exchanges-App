...
class RestClient(object):
    ...
    def getorderbook(self, instrument,depth):
        return self.request("/api/v1/public/getorderbook", {'instrument': instrument,'depth':depth})
...
if __name__ == "__main__":
    ...
    data = deribit_api.getsummary(instrument[0]['instrumentName'])
